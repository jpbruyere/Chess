...
//				Matrix4.CreateTranslation(new Vector3(x, y, z));
		...
		public void UpdateColor(){
			if (Player.Color == ChessColor.White) {
				Mesh.SetColor (InstanceIndex, Crow.Configuration.Global.Get<Color> ("WhiteColor").ToVector4());
				...
				Mesh.SetColor (InstanceIndex, Crow.Configuration.Global.Get<Color> ("BlackColor").ToVector4());
